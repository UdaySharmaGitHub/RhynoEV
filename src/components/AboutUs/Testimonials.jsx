...
export const Testimonials = () => {
  return (
    <section className="py-10 bg-primarywhite-400 dark:bg-primarydark-100 dark:text-primarywhite-100 sm:py-15 lg:py-10">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <UpdateFollower
                ...
                data-aos="fade-up"
                data-aos-delay="200"
                className="text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl dark:text-primaryyellow-200">What our customers say</h2>
            </UpdateFollower>    
            <p 
            data-aos="fade-up"
            data-aos-delay="400"
            className="max-w-lg mx-auto mt-4 text-base leading-relaxed">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis.</p>
        </div>

        <div 
        data-aos="fade-up"
        data-aos-delay="600"
        className="grid grid-cols-1 gap-6 px-4 mt-8 sm:px-0 xl:mt-10 xl:grid-cols-4 sm:grid-cols-2">
