...
import SpaceCity2 from "../../assets/slider4.png";
import SpaceCity3 from "../../assets/blueslider.png";
import SpaceCity4 from "../../assets/slider5.png";
import SpaceCity5 from "../../assets/goldenSlider.png";
import SpaceCity6 from "../../assets/redSlider.png";
    ...
    return (
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 pb-4 max-w-7xl">
            <div className="flex items-end justify-between">
                ...
                <UpdateFollower
                    ...
                    data-aos="fade-up"
                    data-aos-delay="500"
                    className="text-3xl font-bold leading-tight mt-6 sm:text-4xl lg:text-5xl dark:text-primaryyellow-200">Rhyno SEO3 Max Products</h2>
                    </UpdateFollower>
                    <p 
                    data-aos="fade-up"
                    data-aos-delay="700"
        ...
        <div className='py-6 w-[80%]'>
          <div className="px-4 sm:px-0">
            <h3 className="text-2xl font-semibold leading-7 ">Features of Rhyno SEO3 Max</h3>
