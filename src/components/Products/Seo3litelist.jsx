...
export const Seo3litelist = () => {
    return (
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 pb-4 max-w-7xl">
            <div className="flex items-end justify-between">
                ...
                <UpdateFollower
                    ...
                    data-aos="fade-up"
                    data-aos-delay="500"
                    className="text-3xl font-bold leading-tight mt-6 sm:text-4xl lg:text-5xl dark:text-primaryyellow-200">Rhyno SEO3 Lite Products</h2>
                    </UpdateFollower>
                    <p 
                    data-aos="fade-up"
                    data-aos-delay="700"
        ...
        <div className='py-6 w-[80%]'>
          <div className="px-4 sm:px-0">
            <h3 className="text-2xl font-semibold leading-7 ">Features of Rhyno SEO3 Lite</h3>
          ...
          <div className="mt-6 border-t border-gray-100">
            <dl className="divide-y divide-gray-100">
              <div className="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd className="mt-1 text-sm leading-6 sm:col-span-2 sm:mt-0">1.8Kwh</dd>
              </div>
              <div className="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
    ...
    Waterproof (IP67)
              ...
              <div className="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd className="mt-1 text-sm leading-6  sm:col-span-2 sm:mt-0">3 hours (12A)</dd>
              </div>
              <div className="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <div className="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd className="mt-1 text-sm leading-6  sm:col-span-2 sm:mt-0">50 km/h</dd>
              </div>
              <div className="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <div className="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                <dt className="text-sm font-medium leading-6 ">Max range (@3full)</dt>
                <dd className="mt-1 text-sm leading-6  sm:col-span-2 sm:mt-0">70 km</dd>
              </div>
              <div className="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                <dt className="text-sm font-medium leading-6 ">Max range (@45km/h)</dt>
                <dd className="mt-1 text-sm leading-6  sm:col-span-2 sm:mt-0">90 km</dd>
              </div>
              <div className="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
