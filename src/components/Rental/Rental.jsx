...
export const Rental = () => {
  return (
    <section className="py-10 bg-white dark:text-primarywhite-100 text-primarydark-300 dark:bg-primarydark-300 sm:py-16 lg:py-24">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center">
            <h2
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-4xl font-bold dark:text-primaryyellow-100 lg:text-5xl sm:text-5xl">Pricing &amp; Plans</h2>
            <p 
            data-aos="fade-up"
            data-aos-delay="400"
            className="mt-4 text-lg leading-relaxed ">Amet minim mollit non deserunt ullam co est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
        </div>
        ...
        className="hidden mt-16 lg:block">
            <table className="w-full">
                ...
                <tbody>
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">App Subscription</td>

                        <td className="px-4 py-4 text-center border-b border-gray-200"><svg className="w-5 h-5 mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <td className="px-4 py-4 text-center text-white bg-gray-900 border-b border-white/20"><svg className="w-5 h-5 mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                            </svg></td>
                    ...
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">Live tracking</td>
                    ...
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">Maintaince</td>
                    ...
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">Security Checks</td>
                    ...
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">fast Delivery</td>
                    ...
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">24/7 Customer Support</td>
                    ...
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">Customization</td>
                    ...
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">Battery Checks</td>
                    ...
                    <tr>
                        ...
                        <td className="px-4 py-6 text-center">
                            <a href="#" title="" className="inline-flex items-center font-semibold text-blue-600 dark:text-primaryyellow-200">
                                Get Started
                        ...
                        <td className="px-4 py-6 text-center text-white bg-primarydark-300 dark:bg-primaryyellow-100 rounded-b-xl">
                            <a href="#" title="" className="inline-flex items-center font-semibold text-white dark:text-primarydark-300">
                                Get Started
                                <svg className="w-4 h-4 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
